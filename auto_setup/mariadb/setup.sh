...
MARIADB_SHARED=MariaDB-10.1.8-centos6-x86_64-shared
MARIADB_SHARED_DOWNLOAD_PATH=http://mirrors.opencas.cn/mariadb/mariadb-10.1.8/yum/centos6-amd64/rpms/$MARIADB_SHARED.rpm

MARIADB_CLIENT=MariaDB-10.1.8-centos6-x86_64-client
MARIADB_CLIENT_DOWNLOAD_PATH=http://mirrors.opencas.cn/mariadb/mariadb-10.1.8/yum/centos6-amd64/rpms/$MARIADB_CLIENT.rpm


MARIADB_SERVER=MariaDB-10.1.8-centos6-x86_64-server
MARIADB_SERVER_DOWNLOAD_PATH=http://mirrors.opencas.cn/mariadb/mariadb-10.1.8/yum/centos6-amd64/rpms/$MARIADB_SERVER.rpm

MARIADB_COMMON=MariaDB-10.1.8-centos6-x86_64-common
MARIADB_COMMON_DOWNLOAD_PATH=http://mirrors.opencas.cn/mariadb/mariadb-10.1.8/yum/centos6-amd64/rpms/$MARIADB_COMMON.rpm

MARIADB_COMPAT=MariaDB-10.1.8-centos6-x86_64-compat
MARIADB_COMPAT_DOWNLOAD_PATH=http://mirrors.opencas.cn/mariadb/mariadb-10.1.8/yum/centos6-amd64/rpms/$MARIADB_COMPAT.rpm
